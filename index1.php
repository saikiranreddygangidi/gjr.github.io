				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<?php } ?>
							<li><a href="postbycomp.php">POST SERVICES</a></li>
...
$sql="select * from  cbuilding where to1='$b'";

$rec=mysqli_query($conn,$sql);

while($row = mysqli_fetch_assoc($rec))
	{echo "<div id=fh5co-blog-section>
        <div class=row>
				<div class=w3-card-4 style='border:1px solid black;width:300px;margin-left:80px;' >
					<div class=blog-grid style=width:300px;height:300px; >
					<img src=$row[image] class=img-responsive alt=Image style=width:100%;height:100%>
						
					</div>
					<div class=desc>
						<h4>from :-$row[from1]--> <br>to:-$row[to1]</h4>
						<h4>cost:->$row[cost]</h4>
					</div>
				</div>
	  </div>
...
<form action="noti.php" method="post">
 ...
 <INPUT TYPE="hidden" name="w4" id="w4" value="$row[company name]"> 
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="desc">
						<h3><a href="#">ticket from america to india</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					...
					<div class="desc">
						<h3><a href="#">booking to thrupathi</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					...
					<div class="desc">
						<h3><a href="#">booking from india to dubai with low cost</a></h3>
					</div>
				</div>
			</div>
		</div>
