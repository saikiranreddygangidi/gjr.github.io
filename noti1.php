...
$d=$_POST['w4'];
$e=$row['id'];
$sql5="insert into grand(no,from1,to1,companyname) values ('$a','$b','$c','$d')";
$result=mysqli_query($conn1, $sql5);
 echo "<div class=j>
         <h2 style=color:white;>granded the  request  by $d</h2>";
  echo "<h3 style=color:white> this start from </h3>";
echo "</div>";
}
if(isset($_POST['rr1']))
{
 echo "<div class=j>
         <h2 style=color:black;>sorry we dont have this route selection</h2>";
  echo "<h3 style=color:black>we will try it again within today we will give u update</h3>";
echo "</div>";}
if(isset($_POST['w61']))
{$a=$_POST['w11'];
$b=$_POST['w21'];
...
$d=$_POST['w41'];
$e=$row['id'];
$sql5="insert into notgrand(no,from1,to1,companyname) values ('$a','$b','$c','$d')";
$result=mysqli_query($conn1, $sql5);
 echo "<div class=j>
         <h2 style=color:white;>granded the  request  by $d</h2>";
  echo "<h3 style=color:white> sorry at present there is no permissions</h3>";
echo "</div>";
}
