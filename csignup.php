...
$ran=rand();
$f=1;
$sql="insert into csignup(`username`, `first name`, `last name`, `city`, `state`, `password`, `image`, `email`, `id`) values ('$u1','$u2','$u3','$u4','$u5','$u6','$image','$u7','$ran')";
